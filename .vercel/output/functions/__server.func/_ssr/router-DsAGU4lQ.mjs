...
import { H as useStore, M as require_react_dom, V as useRouter, f as escapeHtml, u as deepEqual, z as useHydrated } from "./react-dom-r1iQObTW.mjs";
import { t as Link } from "./link-BUYuhDlp.mjs";
import { A as record, C as isParsableJson, D as object$1, E as number, F as withUserAgentSuffix, I as withoutTrailingSlash, M as string, N as union, O as parseProviderOptions, P as useStructuralSharing, S as generateId, T as literal, _ as createEventSourceResponseHandler, a as Route$8, b as createJsonResponseHandler, c as UnsupportedFunctionalityError, d as array, f as boolean, g as convertToModelMessages, h as convertToBase64, i as InvalidResponseDataError, j as streamText, k as postJsonToApi, l as _enum, m as combineHeaders, o as SYSTEM_PROMPT, r as InvalidPromptError, s as TooManyEmbeddingValuesForCallError, u as any, v as createFileRoute, w as lazyRouteComponent, x as createRootRouteWithContext, y as createJsonErrorResponseHandler } from "./ask._threadId-Kr5r3fuw.mjs";
...
import { a as RouterCore, d as createNonReactiveMutableStore, f as createNonReactiveReadonlyStore, h as getScriptPreloadAttrs, i as Outlet, m as getAssetCrossOrigin, s as appendUniqueUserTags, v as resolveManifestCssLink } from "./Match-B9uJNwoS.mjs";
import { t as flower_default } from "./flower-B06oMxf0.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-DsAGU4lQ.js
...
var $$splitComponentImporter$5 = () => import("./routes-B_WxUFkk.mjs");
...
var $$splitComponentImporter$4 = () => import("./assessment--1kf992X.mjs");
...
var $$splitComponentImporter$3 = () => import("./doctor-DJ1GTDqZ.mjs");
...
var $$splitComponentImporter$2 = () => import("./history-D0-fT9zJ.mjs");
...
var $$splitComponentImporter$1 = () => import("./tracker-7iXB4Jnf.mjs");
...
var openaiCompatibleTokenUsageSchema = object$1({
	...
	prompt_tokens_details: object$1({ cached_tokens: number().nullish() }).nullish(),
...
var createOpenAICompatibleChatChunkSchema = (errorSchema) => union([object$1({
	id: string().nullish(),
	created: number().nullish(),
	model: string().nullish(),
	choices: array(object$1({
...
var openaiTextEmbeddingResponseSchema = object$1({
	data: array(object$1({ embedding: array(number()) })),
...
var openaiCompatibleImageResponseSchema = object$1({ data: array(object$1({ b64_json: string() })) });
var VERSION = "1.0.46";
...
var $$splitComponentImporter = () => import("./ask.index-BSIUMGzw.mjs");
