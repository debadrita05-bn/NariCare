import { $ as record, A as postJsonToApi, H as any, I as withUserAgentSuffix, J as literal, L as withoutTrailingSlash, Q as object, U as array, W as boolean, Z as number, at as InvalidPromptError, b as generateId, ct as UnsupportedFunctionalityError, d as convertToBase64, et as string, g as createJsonResponseHandler, h as createJsonErrorResponseHandler, k as parseProviderOptions, l as combineHeaders, ot as InvalidResponseDataError, p as createEventSourceResponseHandler, st as TooManyEmbeddingValuesForCallError, tt as union, w as isParsableJson, z as _enum } from "./@ai-sdk/gateway+[...].mjs";
		...
		return {
			stream: response.pipeThrough(new TransformStream({
				...
				transform(chunk, controller) {
					...
					const choice = value.choices[0];
					if ((choice == null ? void 0 : choice.finish_reason) != null) finishReason = mapOpenAICompatibleFinishReason2(choice.finish_reason);
